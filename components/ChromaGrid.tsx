...
const ChromaGrid: React.FC<ChromaGridProps> = ({
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className='relative z-10 flex-1 p-[10px] box-border'>
            <Image
              ...
              width={900}
              height={300}
              className='aspect-video object-cover rounded-[10px]'
            />
          </div>
      ...
      {/* Edge-fade: transparent at edges so this layer doesn't form a visible box; grayscale only in center. */}
      <div
        ...
        style={{
          ...
          maskImage: `linear-gradient(to right, transparent 0%, white 4%, white 96%, transparent 100%),
            linear-gradient(to bottom, transparent 0%, white 4%, white 96%, transparent 100%),
