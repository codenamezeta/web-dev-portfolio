---
title: Wedding Event Portal & Guest Logistics
category: Personal
publishedAt: 2022-11-11
description: A high-performance, minimalist event portal built with semantic HTML5, CSS3, and Vanilla JavaScript to coordinate guest logistics, accommodations, and registries.
liveUrl: https://kellyandmichaelgethitched.com
sourceUrl: https://github.com/codenamezeta/Zeta_Wedding
image: /imgs/wedding/kandm-01.png
keywords: UX/UI Design, Semantic HTML, Vanilla CSS, Animated SVG
featuredOrder: 03
---
...
- **Semantic HTML5:** Structuring the document purely with semantic tags (`<article>`, `<section>`, `<nav>`) for optimal SEO and accessibility.
- **Modern CSS3:** Utilizing CSS Flexbox and Grid for complex, responsive layouts without the bloat of external CSS libraries or frameworks. Custom CSS variables were used to maintain a consistent color theme.
